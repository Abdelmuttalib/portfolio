    ...
    <Layout>
      ...
      <section className="layout flex min-h-screen flex-col items-center justify-center text-left">
        <div className="mb-20 flex w-full max-w-3xl flex-col gap-4">
          <h1 className="text-left text-5xl font-bold tracking-[-0.2rem] text-[#1c1c1c] antialiased sm:text-6xl md:text-8xl md:tracking-[-0.5rem]">
            Building beautiful web experiences{" "}
          </h1>
          <p className="font-normal text-gray-600 md:pr-20 md:text-xl">
            a web developer,{" "}
